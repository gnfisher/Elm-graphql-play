...
module Api.Scalar exposing (Codecs, Date(..), DateTime(..), GitObjectID(..), GitSSHRemote(..), GitTimestamp(..), Html(..), Id(..), PreciseDateTime(..), Uri(..), X509Certificate(..), defaultCodecs, defineCodecs, unwrapCodecs, unwrapEncoder)

...
module Api.Object.GistFile exposing (TextOptionalArguments, encodedName, encoding, extension, isImage, isTruncated, language, name, size, text)
...
-}
language : SelectionSet decodesTo Api.Object.Language -> SelectionSet (Maybe decodesTo) Api.Object.GistFile
language object_ =
...
-}
text : (TextOptionalArguments -> TextOptionalArguments) -> SelectionSet (Maybe String) Api.Object.GistFile

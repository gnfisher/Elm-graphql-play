...
module Api.Object.ConvertedNoteToIssueEvent exposing (actor, createdAt, databaseId, id)
...
-}
actor : SelectionSet decodesTo Api.Interface.Actor -> SelectionSet (Maybe decodesTo) Api.Object.ConvertedNoteToIssueEvent
actor object_ =

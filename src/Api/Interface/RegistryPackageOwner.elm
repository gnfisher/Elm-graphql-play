...
module Api.Interface.RegistryPackageOwner exposing (Fragments, RegistryPackagesOptionalArguments, fragments, id, maybeFragments, registryPackages)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Interface.RegistryPackageOwner
...
id : SelectionSet Api.ScalarCodecs.Id Api.Interface.RegistryPackageOwner
id =
...
-}
registryPackages : (RegistryPackagesOptionalArguments -> RegistryPackagesOptionalArguments) -> SelectionSet decodesTo Api.Object.RegistryPackageConnection -> SelectionSet decodesTo Api.Interface.RegistryPackageOwner

...
module Api.Interface.Starrable exposing (Fragments, StargazersOptionalArguments, fragments, id, maybeFragments, stargazers, viewerHasStarred)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Interface.Starrable
...
id : SelectionSet Api.ScalarCodecs.Id Api.Interface.Starrable
id =
...
-}
stargazers : (StargazersOptionalArguments -> StargazersOptionalArguments) -> SelectionSet decodesTo Api.Object.StargazerConnection -> SelectionSet decodesTo Api.Interface.Starrable
...
-}
viewerHasStarred : SelectionSet Bool Api.Interface.Starrable
viewerHasStarred =

...
module Api.Interface.OrganizationAuditEntryData exposing (Fragments, fragments, maybeFragments, organization, organizationName, organizationResourcePath, organizationUrl)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Interface.OrganizationAuditEntryData
...
-}
organization : SelectionSet decodesTo Api.Object.Organization -> SelectionSet (Maybe decodesTo) Api.Interface.OrganizationAuditEntryData
...
-}
organizationName : SelectionSet (Maybe String) Api.Interface.OrganizationAuditEntryData
organizationName =
...
-}
organizationResourcePath : SelectionSet (Maybe Api.ScalarCodecs.Uri) Api.Interface.OrganizationAuditEntryData
...
-}
organizationUrl : SelectionSet (Maybe Api.ScalarCodecs.Uri) Api.Interface.OrganizationAuditEntryData
organizationUrl =

...
module Api.Enum.OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility exposing (OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility(..), decoder, fromString, list, toString)

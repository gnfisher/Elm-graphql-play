...
module Api.Enum.OrgUpdateDefaultRepositoryPermissionAuditEntryPermission exposing (OrgUpdateDefaultRepositoryPermissionAuditEntryPermission(..), decoder, fromString, list, toString)

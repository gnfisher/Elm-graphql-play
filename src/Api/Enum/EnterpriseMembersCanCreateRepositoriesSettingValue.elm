...
module Api.Enum.EnterpriseMembersCanCreateRepositoriesSettingValue exposing (EnterpriseMembersCanCreateRepositoriesSettingValue(..), decoder, fromString, list, toString)

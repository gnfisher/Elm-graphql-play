...
module Api.Union.CreatedIssueOrRestrictedContribution exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Union.CreatedIssueOrRestrictedContribution

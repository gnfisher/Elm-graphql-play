...
module Api.Union.ReviewDismissalAllowanceActor exposing (Fragments, fragments, maybeFragments)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.Union.ReviewDismissalAllowanceActor
